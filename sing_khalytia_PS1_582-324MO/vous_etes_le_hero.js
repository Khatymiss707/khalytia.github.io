chapters = {
    ...
    commoner: {
        ...
        boutons : [ 
            ...
            {titre: '▶ Roxie', destination: 'goToChapter(\"roxie\")'}, 
            {titre: '▶ Steve', destination: 'goToChapter(\"steve\")'},
        ]
    }, 
    keymaster: {
        titre: "Vote final",
        ...
        boutons : [ 
            ...
            {titre: '▶ Anna', destination: 'goToChapter(\"anna\")'},
            {titre: '▶ Roxie', destination: 'goToChapter(\"roxie\")'}, 
            {titre: '▶ Steve', destination: 'goToChapter(\"pitie\")'},
        ]
    }, 
    keith: {
        titre: "Keith",
...
function goToChapter(chapter) {
    if (chapters[chapter]) {
        ...
        chapters[chapter].boutons.forEach((boutons) => {
           console.log(boutons.titre + ': Taper dans la console ' + boutons.destination); 
        }    
        )
