const chapters = {
  ...
  debut: {
    titre: "Introductions",
    description:
      " Keith, un policier, se présente, manifestant une certaine hésitation dans sa voix. Roxie, au look punk, révèle avoir vécu la même situation que toi, et Anna, une jeune fille d'environ 12 à 14 ans, semble en détresse. Ne sachant pas quoi faire, tu la réconfortes, comprenant sa situation.",
  ...
  bar: {
    ...
    boutons: [
      {
        titre: "▶ Les bouteilles d’alcool",
        destination: "bouteilles1",
      },
      {
        titre: "▶ le cabinet avec un creux profond",
        destination: "cabinet",
      },
    ],
  },
  ...
  bouteilles1: {
    ...
    description:
      "Tu décides d'inspecter les bouteilles. En soulevant et en secouant chaque bouteille, tu remarques une carte suspecte sous l'une d’elles. Elle est petite et illustrée avec un symbole de clé. Confus, tu retournes la carte pour y trouver un court paragraphe. La clé de la maîtrise assure l'immunité, mais à quel prix ? Garde-la secrète, sinon le danger guette. Pris de panique, tu scrutes rapidement la pièce avant de glisser la carte dans l'une de tes poches. Vous continuez à fouiller le bar avant de prendre une pause sur les chaises. Tu remarques qu’Anna semblent encore plus en détresse que tantôt. Keith remarque ton hausse de nervosité, mais tu lui dit que tout est correct.",
    image: "./assets/images/images_jeu/keymaster.png",
    musique: "exploration_ost.mp3",
    boutons: [
      {
        titre: "▶ Continuer",
        destination: "rouletterusse1",
      },
    ],
  },
  bouteilles2: {
  ...
  rouletterusse1: {
    ...
    boutons: [
      {
        titre: "▶ Finir sa boisson",
        destination: "aidelait1",
      },
      {
        titre: "▶ La forcer à finir",
        destination: "forcelait1",
      },
    ],
  },
  rouletterusse2: {
    ...
    boutons: [
      {
        titre: "▶ Finir sa boisson",
        destination: "aidelait2",
      },
      {
        titre: "▶ La forcer à finir",
        destination: "forcelait2",
      },
    ],
  },
  forcelait1: {
  ...
  memoire: {
    ...
    boutons: [
      {
        titre: "▶ La carte Commoner",
        destination: "commoner",
      },
      {
        titre: "▶ La carte Keymaster",
        destination: "keymaster",
      },
    ],
  },
  plan: {
  ...
  keith: {
    ...
    video: "./assets/videos/keith_mort.mov",
  ...
  anna: {
    ...
    video: "./assets/videos/anna_mort.mov",
    musique: "ithukusimu_ost.mp3",
    boutons: [
      {
        titre: "▶ Recommencer",
  ...
  roxie: {
    ...
    video: "./assets/videos/roxie_mort.mov",
    musique: "ithukusimu_ost.mp3",
    boutons: [
      {
        titre: "▶ Recommencer",
  ...
  pitie: {
    ...
    video: "./assets/videos/steve_mort.mov",
    musique: "ithukusimu_ost.mp3",
    boutons: [
      {
        titre: "▶ Recommencer",
...
let input = document.querySelector(".mute");
